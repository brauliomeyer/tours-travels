                                ...
                                <div class="">
                                    ...
                                    <div id="envelope">
                                        ...
                                        if (isset($_GET['submit']) == 'Proceed') {
                                            echo $city = $_GET['city'];
                                            echo $State = $_GET['shop'];
                                            header("location:test.php?Statename=$State&city=$city");
                                        }
                                        ?>
                                        ...
                                        <form name ="addContent" onsubmit="return validateForm();" method="get" enctype="multipart/form-data">
                                            <header>
                                                ...
                                                <h1 style="color:red;">Add Places Here</h1>
                                            </header>

                                            <label>Statename</label>
                                            <?php
                                            $sql111 = "select * from managestates";
                                            $query111 = mysql_query($sql111);
                                            ?>
                                            <select name="shop" onchange="showUser(this.value)">
                                                <option value=""> --- Select a state --- </option>
                                                <?php
                                                while ($row111 = mysql_fetch_array($query111)) {
                                                    $Statename = $row111["state_name"];
                                                    ?>
