                ...
                <div id="content" class="col-lg-10 col-sm-10">
                    ...
                    <div>
                        <ul class="breadcrumb">
                            ...
                            <li>
                                <a href="gallery_listing.php">Listing gallery </a>
                            </li>
                        </ul>
                    </div>
...
// Connect to server and select databse.
                    ...
                    $query = "SELECT * FROM managegallery";
...
// Check if delete button active, start this
                    if (isset($_POST['delete']) == "Delete") {
                        ...
                        foreach ($rr as $id_cities) {
                            ...
                            $query = "DELETE FROM managegallery WHERE id='$id'";
                            $result = mysql_query($query);
                        }
                                ...
                                <form name ="addContent" action="" method="post" enctype="multipart/form-data">
                                    <table width="100%" border="0" cellpadding="3" cellspacing="1">
                                        <tr style="background-color: green;">
                                            <td align="center" colspan="7"><strong>Cities content</strong> </td>
                                        </tr>
                                        ...
                                        while ($rows = mysql_fetch_array($result)) {
                                            ...
                                            <tr colspan="1" class="<?php if (isset($classname)) echo $classname; ?>">
                                                ...
                                                <td align="center"><?php echo $state = $rows['state']; ?></td>
                                                <td align="center"><?php echo $city = $rows['city']; ?></td>
                                                <td align="center"><?php echo $place = $rows['place']; ?></td>
                                                <td align="center"><img src="news/<?php echo $image = $rows['image']; ?>" width="100"height="100"></td>
                                                <td align="center"><a class="underline" href="gallery_add.php?id=<?php echo $id; ?>">Add</a> / <a class="underline" href="gallery_view.php?id=<?php echo $id; ?>">View</a> / <a class="underline" href="gallery_update.php?id=<?php echo $id; ?>">Update</a></td>
                                            </tr>
