    ...
    <head>
        ...
        <script type="text/javascript">
            function showUser(str)
            {
                ...
                xmlhttp.open("GET", "getuserhotel.php?q=" + str, true);
                xmlhttp.send();
            }
        </script>
                                ...
                                <div class="">
                                    ...
                                    <div id="envelope">
                                        ...
                                        if (isset($_GET['submit']) == 'Proceed') {
                                            $city = $_GET['city'];
                                            $state_name = $_GET['state_name'];
                                            header("location:testhotels.php?state=$state_name&city=$city");
                                        }
                                        ?>
                                        ...
                                        <form name ="addContent" onsubmit="return validateForm();" method="get" enctype="multipart/form-data">
                                            ...
                                            <label>State</label>
                                            <?php
                                            $sql33 = "SELECT * FROM managestates";
