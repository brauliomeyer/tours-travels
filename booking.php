                        ...
                        <div class="9u skel-cell-important">
                            ...
                            <section>
                                ...
                                while ($row2 = mysql_fetch_array($result2)) {
                                    ...
                                    $history = $row2['hotel_range'];
                                    $distance = $row2['facilities'];
                                    $near_places = $row2['food'];
                                }
                                ?>
                                    ...
                                    <form name="addContent" onsubmit="validateForm()" method="post" enctype="multipart/form-data">
                                        <table  cellspacing="5" cellpadding="5" border="1" align="center">
                                            ...
                                            <table border="1" align="center" cellpadding="5">
                                                ...
                                                <tr>
                                                    <td>State:</td>
                                                    <td><input type="text" name="state_name" value="<?php echo $state_name; ?>" readonly required></td>
                                                </tr>
                                                <tr>
                                                    <td>City:</td>
                                                    <td><input type="text" name="city" value="<?php echo $city; ?>" readonly required></td>
                                                </tr>
                                                <tr>
                                                    <td>Hotel:</td>
                                                ...
                                                <tr>
                                                    <td>Check-In:</td>
                                                    <td><input type="text" class="w8em format-d-m-y highlight-days-67 range-low-today" name="start_date" id="sd" maxlength="10" readonly="readonly" required placeholder="Enter a valid date"></td>
                                                </tr>
                                                <tr>
                                                    <td>Check-Out:</td>
                                                    <td><input type="text" class="w8em format-d-m-y highlight-days-67 range-low-today" name="end_date" id="ed" maxlength="10" readonly="readonly" required placeholder="Enter a valid date"></td>
                                                </tr>
                                                <tr>
                                                    <td>Name:</td>
