...
<tr><td>
	<header>
		<a href="toerist_places.php?id=<?php echo $id; ?>"><h3>Places</h3></a>
	</header>

	<?php
		// Connect to server and select databse
    	include("common/connection.php");
    $states=$_GET['state_name'];           // 2xstate_name
     $city=$_GET['city'];
    	 $query = "SELECT * FROM manageplaces where states='".$states."' and city='".$city."'"; // 1xstate_name
